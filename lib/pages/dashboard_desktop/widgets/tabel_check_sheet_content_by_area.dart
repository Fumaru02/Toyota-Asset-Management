...
class TabelCheckSheetContentByArea extends StatefulWidget {
  const TabelCheckSheetContentByArea({super.key});

  @override
  _TabelCheckSheetContentByAreaState createState() =>
      _TabelCheckSheetContentByAreaState();
}

class _TabelCheckSheetContentByAreaState
    extends State<TabelCheckSheetContentByArea> {
