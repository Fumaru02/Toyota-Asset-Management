...
class TabelUpdateContent extends StatefulWidget {
  const TabelUpdateContent({super.key});

  @override
  _TabelUpdateContentState createState() => _TabelUpdateContentState();
}

class _TabelUpdateContentState extends State<TabelUpdateContent> {
  ...
  void _initializeColumns() {
    columns = <PlutoColumn>[
      ...
      _buildColumn(
          'Input Time', 'input_time_field', PlutoColumnType.text(), false),
