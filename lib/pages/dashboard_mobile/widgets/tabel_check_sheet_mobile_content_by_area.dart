...
class TabelCheckSheetMobileContentByArea extends StatefulWidget {
  const TabelCheckSheetMobileContentByArea({super.key});

  @override
  _TabelCheckSheetMobileContentByAreaState createState() =>
      _TabelCheckSheetMobileContentByAreaState();
}

class _TabelCheckSheetMobileContentByAreaState
    extends State<TabelCheckSheetMobileContentByArea> {
                  ...
                  children: <Widget>[
                    if (dashboardController.isLoading.value)
                      ...
                      SizedBox(
                        ...
                        child: StreamBuilder(
                          stream: dashboardController.streamRowCheckSheetByArea(
