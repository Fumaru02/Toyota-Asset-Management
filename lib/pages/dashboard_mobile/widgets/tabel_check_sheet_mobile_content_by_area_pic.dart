...
class TabelCheckSheetMobileContentByAreaPic extends StatefulWidget {
  const TabelCheckSheetMobileContentByAreaPic({super.key});

  @override
  _TabelCheckSheetMobileContentByAreaPicState createState() =>
      _TabelCheckSheetMobileContentByAreaPicState();
}

class _TabelCheckSheetMobileContentByAreaPicState
    extends State<TabelCheckSheetMobileContentByAreaPic> {
          ...
          children: <Widget>[
            ...
            InkWell(
              onTap: () {
                showDialog(
                    context: context,
                    builder: (BuildContext context) => MobilePickImage(
                  ...
                  children: <Widget>[
                    if (dashboardController.isLoading.value)
                      ...
                      SizedBox(
                        ...
                        child: StreamBuilder(
                          stream:
                              dashboardController.streamRowCheckSheetByAreaPic(
